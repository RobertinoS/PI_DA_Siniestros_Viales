...
def total_victimas_por_mes(dataframe):
    '''
    Crea un gráfico de barras que muestra la cantidad de víctimas de accidentes por mes utilizando Altair.
    ...
    # Se crea el gráfico con Altair
    chart = alt.Chart(datos_agrupados).mark_bar().encode(
        x='Mes',
        y='Cantidad de victimas'
    ).properties(
        title='Cantidad de víctimas por Mes'
    ).configure_axis(
        labelFontSize=12,    # Tamaño de fuente de etiquetas en el eje x
        titleFontSize=14     # Tamaño de fuente del título del eje x
    )
...
def accidentes_por_tipo_dia(datos):
    '''
    Genera un gráfico de barras que muestra la cantidad de accidentes por tipo de día (semana o fin de semana) utilizando Altair.
    ...
    # Se crea el gráfico de barras con Altair
    chart = alt.Chart(datos_agrupados).mark_bar().encode(
        x='Tipo de dia',
        y='Cantidad de accidentes'
    ).properties(
        title='Cantidad de accidentes por tipo de día'
    ).configure_axis(
        labelFontSize=12,    # Tamaño de fuente de etiquetas en el eje x
        titleFontSize=14     # Tamaño de fuente del título del eje x
    )
...
def resumen_victimas_sexo(datos):
    '''
    Genera un resumen de la cantidad de víctimas por sexo, rol y tipo de vehículo en un accidente de tráfico utilizando Altair.
    ...
    chart3 = alt.Chart(datos).mark_bar().encode(
        x='Victima',
        y='count()',
        color='Sexo'
    ).properties(
        title='Cantidad de víctimas por tipo de vehículo'
    ).configure_axis(
        labelFontSize=12,    # Tamaño de fuente de etiquetas en el eje x
        titleFontSize=14     # Tamaño de fuente del título del eje x
    )
...
def grafico_edades(datos):
    ...
    chart_hist = alt.Chart(datos).mark_bar().encode(
        x=alt.X('Edad', bin=alt.Bin(maxbins=20)),
        y='count()'
    ).properties(
    ...
    # Boxplot de la edad
    chart_box = alt.Chart(datos).mark_boxplot().encode(
        x='Edad:Q'
    ).properties(
...
def accidentes_por_anio_y_genero(datos):
    '''
    Genera un gráfico de barras que muestra la cantidad total de víctimas por año y género utilizando Altair.
...
def victimas_edad_y_rol(df):
    '''
    Genera un gráfico de caja de la distribución de la edad de las víctimas por rol utilizando Altair.
    ...
    Returns:
        None
    '''
    # Gráfico de caja de la distribución de la edad por rol con Altair
    chart = alt.Chart(df).mark_boxplot().encode(
        y='Rol:N',
        x='Edad:Q'
    ).properties(
        title='Distribución de la Edad de las Víctimas por Rol'
    ).configure_axis(
        labelFontSize=12,    # Tamaño de fuente de etiquetas en el eje y
        titleFontSize=14     # Tamaño de fuente del título del eje y
    )
...
def participantes_victimas_accidentes(df):
    ...
    # Crea el gráfico interactivo de barras con Altair
    chart = alt.Chart(conteo_victimas).mark_bar().encode(
        x='Participantes:N',
        y='Cantidad de victimas:Q'
    ).properties(
...
def participantes_accidentes_calle_cruce(datos_accidentes):
    ...
    # Gráfico de barras horizontal para el total por tipo de calle con Altair
    chart_tipo_calle = alt.Chart(total_victimas_calle).mark_bar().encode(
        x='Cantidad de victimas:Q',
        y='Tipo de calle:N'
    ).properties(
    ...
    # Gráfico de barras horizontal para el total por presencia de cruce con Altair
    chart_cruce = alt.Chart(total_victimas_cruce).mark_bar().encode(
        x='Cantidad de victimas:Q',
        y='Cruce:N'
    ).properties(
...
def acusados_en_accidentes(datos):
    ...
    # Crea el gráfico de barras horizontal con Altair
    chart = alt.Chart(conteo_acusados).mark_bar().encode(
        x='Total:Q',
        y='Acusado:N'
    ).properties(
